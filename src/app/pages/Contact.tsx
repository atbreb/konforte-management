                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="central-plaza">Central Plaza Shopping Center</SelectItem>
                            <SelectItem value="lakeside-retail">Lakeside Retail Center</SelectItem>
                            <SelectItem value="cornerstone-commons">Cornerstone Commons</SelectItem>
